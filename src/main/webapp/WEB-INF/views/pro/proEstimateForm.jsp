...
<title>Insert title here</title>
    <script>
        function sendEstimate(){
                socket.send('/chat/estimate', {}, JSON.stringify({sender:${proDTO.email} ,sender_name:${proDTO.name },
                    message: "msg",
                    receiver:${estimateDTO.account_id}}));
                return true;
        }
...
<form action="<%=request.getContextPath() %>/pro/proEstimatePro" method="get" onsubmit="return sendEstimate()">
...
<input type="text" readonly="readonly" style="font-weight: bold;" value=" c"><br>
...
<input type="submit" id="submit" value="견적서 보내기" >
</form>
<footer>

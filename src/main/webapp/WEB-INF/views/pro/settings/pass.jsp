...
<div class="page-section" style="padding-top: 0px">
    <div class="container">
        <form action="<%=request.getContextPath() %>/pro/settings/pass-update" class="contact-form py-5 px-lg-5" style="width: 700px; margin: auto;" method="post" id="update">
            ...
            <div class="row form-group">
                <div class="col-md-12" style="width: 100%; padding-bottom: 30px; margin-top: 50px;">
                    ...
                    <div class="input-group" data-validate="email">
                        <input type="password" class="form-control" name="oldpass" placeholder="현재 비밀번호를 입력해주세요"  style="border-radius: 0.25rem;" id="oldpass" autocomplete="false">
                    </div>
                ...
                <div class="col-md-12" style="width: 100%; margin-top: 30px;">
                    ...
                    <div class="input-group" data-validate="newEmail1">
                        <input type="password" class="form-control" name="password" placeholder="영문+숫자 조합 8자리 이상 입력해주세요"  style="border-radius: 0.25rem;" id="password">
                    </div>
                ...
                <div class="col-md-12" style="width: 100%; margin-top: 30px; padding-bottom: 50px;">
                    ...
                    <div class="input-group" data-validate="newEmail2">
                        <input type="password" class="form-control" placeholder="비밀번호를 한번 더 입력해주세요" style="border-radius: 0.25rem;" id="password2">
                    </div>
            ...
            <div class="button-group" align="right">
                ...
                <input type="submit" class="btn update" value="변경 완료">
                <input type="hidden" name="id" value="${proDTO.id }">

...
<div class="page-section" style="padding-top: 0px">
  <div class="container">
    <form action="<%=request.getContextPath() %>/pro/settings/name-update" class="contact-form py-5 px-lg-5" style="width: 700px; margin: auto;" method="post" id="update">
      ...
      <div class="row form-group">
        <div class="col-md-12" style="width: 100%; padding-bottom: 50px;">
          ...
          <div class="input-group" data-validate="email">
            <input type="text" class="form-control" name="name" id="name" value="${proDTO.name}" required style="border-radius: 0.25rem;">
            <span class="input-group-addon danger"><span class="glyphicon glyphicon-remove"></span></span>
          </div>
          <div id="namediv" class="invalid-feedback"></div>
        </div>
      </div>

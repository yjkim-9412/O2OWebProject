...
<head>
  ...
  <link rel="stylesheet" href="resources/assets/css/maicons.css">
        ...
        <div class="row align-items-center flex-wrap-reverse h-100">
          ...
          <div class="col-md-6 py-5 wow zoomIn">
            <div class="img-fluid text-center">
              <img src="resources/assets/img/banner_image_1.svg" alt="">
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            <div class="header">
              <img src="resources/assets/img/services/service-1.svg" alt="">
            </div>
            <div class="body">
        ...
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            <div class="header">
              <img src="resources/assets/img/services/service-2.svg" alt="">
            </div>
            <div class="body">
        ...
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            <div class="header">
              <img src="resources/assets/img/services/service-3.svg" alt="">
            </div>
            <div class="body">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 py-3 wow fadeInRight">
          <div class="img-fluid py-3 text-center">
            <img src="resources/assets/img/about_frame.png" alt="">
          </div>
        </div>
      </div>
    </div> <!-- .container -->
...
<script src="resources/assets/js/google-maps.js"></script>

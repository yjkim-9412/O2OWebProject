...
<div id="divbody">
<ul>
<div class="sel"><label for="selcat_num1"><li><input type="radio" id="selcat_num1" name="selcat_num" value="3">반찬/도시락 배달<br></li></label></div>
<div class="sel"><label for="selcat_num2"><li><input type="radio" id="selcat_num2" name="selcat_num" value="4">운동<br></li></label></div>
</ul>
<div id="seldiv"></div>
</div>
<div id="footer">

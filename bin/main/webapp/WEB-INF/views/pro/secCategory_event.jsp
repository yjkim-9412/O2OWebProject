...
<div id="divbody">
<ul>
<div class="sel"><label for="selcat_num1"><li><input type="radio" id="selcat_num1" name="selcat_num" value="12">파티,행사계획<br></li></label></div>
<div class="sel"><label for="selcat_num2"><li><input type="radio" id="selcat_num2" name="selcat_num" value="13">행사MC<br></li></label></div>
<div class="sel"><label for="selcat_num3"><li><input type="radio" id="selcat_num3" name="selcat_num" value="14">영상편집<br></li></label></div>
</ul>
<div id="seldiv"></div>
</div>
<div id="footer">
